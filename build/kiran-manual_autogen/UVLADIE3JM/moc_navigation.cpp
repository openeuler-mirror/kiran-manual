...
QT_MOC_LITERAL(1, 11, 16), // "entryArticlePage"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 3) // "key"

    },
    "Navigation\0entryArticlePage\0\0key"
};
...
void Navigation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->entryArticlePage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Navigation::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Navigation::entryArticlePage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Navigation::entryArticlePage(QString _t1)
{
